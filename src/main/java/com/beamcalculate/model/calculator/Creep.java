...
public class Creep {
    ...
    public Creep(Inputs inputs, double concreteCompStress) {
        ...
        mBetaH = 1.5 * (1 + Math.pow(0.012 * mRH_perc, 18)) * averageRadius_mm + 250 * alpha3;
        ...
        mPhiRH = (1 +
                (1 - mRH_perc / 100) / (0.1 * Math.pow(averageRadius_mm, 1.0/3)) * alpha1
        ) * alpha2;
