...
public class JavaFXIds {
    ...
    //Main Access Window
    public final static String FILE_MENU_ID = "#fileMenu";
    public final static String OPTION_MENU_ID = "#optionMenu";
    public final static String LANGUAGE_MENU_ID = "#languageMenu";
    public final static String FULL_SCREEN_ITEM_ID = "#fullScreenItem";
    public final static String HELP_MENU_ID = "#helpMenu";
    public final static String INPUT_PAGE_BUTTON_ID = "#inputPageButton";
    public final static String MOMENT_PAGE_BUTTON_ID = "#momentPageButton";
    public final static String REBAR_CASES_PAGE_BUTTON_ID = "#rebarCasesPageButton";

    //Input Window
    public final static String T_SHAPED_SECTION_CHECK_ID = "#onTSection_chkb";
    public final static String SAMPLE_INPUT_CHECK_ID = "#sampleInputs_chkb";
    public final static String TOTAL_NUM_SPAN_CHOICE_ID = "#numSpans_chcb";
    public final static String EQUAL_SUPPORT_CHECK_ID = "#equalSupport_chkb";
    public final static String EQUAL_SPAN_CHECK_ID = "#equalSpan_chkb";
    public final static String SPANS_LENGTH_GRID_ID = "#spansLength_gp";
    ...
    public final static String ENVELOP_CURVE_BUTTON_ID = "#envelopCurveGenerate_button";
